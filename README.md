...
- `err_calc.py`: Checks ergodicity by analysing the number of gauche-trans transitions per ns (expect low standard deviation across trajectories). Also estimates uncertainties on basin populations by randomising frames, performing block averaging, and computing the standard error of the mean.
